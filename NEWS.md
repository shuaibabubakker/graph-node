...
- **Derived fields getter**: Derived fields can now be accessed from within mapping code during indexing. ([#4434](https://github.com/graphprotocol/graph-node/pull/4434))
- **Sorting interfaces by child entity**: Interfaces can now be sorted by non-derived child entity. ([#4058](https://github.com/graphprotocol/graph-node/pull/4058))
...
- Allow redeployment of grafted subgraph even when graft_base is not available: This will allow renaming of already synced grafted subgraphs even when the graft base is not available, which previously failed due to `graft-base` validation errors. ([#4695](https://github.com/graphprotocol/graph-node/pull/4695))
...
- The `subgraphFeatures` endpoint now includes data from the `subgraph_features` table.
...
- Add support for overriding module params for substreams based subgraphs when params are provided in subgraph manifest. ([#4759](https://github.com/graphprotocol/graph-node/pull/4759))


### Bug fixes
- Fixed `PublicProofsOfIndexing` returning error `Null value resolved for non-null field proofOfIndexing` error when fetching POI's for blocks which are not in the cache  ([#4768](https://github.com/graphprotocol/graph-node/pull/4768))
- Firehose connection test now retries for 30s before setting the provider status to `Broken` ([#4754](https://github.com/graphprotocol/graph-node/pull/4754))
- Fixed `nonFatalErrors` field not populating in the index node API. ([#4615](https://github.com/graphprotocol/graph-node/pull/4615))
- Fixed `graph-node` panicking on first startup when both firehose and rpc providers are conigured together. ([#4680](https://github.com/graphprotocol/graph-node/pull/4680))
- Fixed block ingestor failing to startup with error `net version for chain mainnet has changed from 0 to 1` when switching from firehose to an RPC provider. ([#4692](https://github.com/graphprotocol/graph-node/pull/4692))
...
- @SozinM made their first contribution in https://github.com/graphprotocol/graph-node/pull/4718
...
- build(deps): bump fallible-iterator from 0.2.0 to 0.3.0 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4652
- build(deps): bump word-wrap from 1.2.3 to 1.2.4 in /tests/runner-tests by @dependabot in https://github.com/graphprotocol/graph-node/pull/4771
* build(deps): bump url from 2.3.1 to 2.4.0 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4672
* build(deps): bump openssl from 0.10.52 to 0.10.54 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4674
* build(deps): bump quote from 1.0.27 to 1.0.28 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4654
* build(deps): bump chrono from 0.4.24 to 0.4.25 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4658
* build(deps): bump tokio from 1.28.1 to 1.28.2 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4659
* build(deps): bump itertools from 0.10.5 to 0.11.0 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4723
* build(deps): bump indexmap from 1.9.3 to 2.0.0 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4722
* build(deps): bump proc-macro2 from 1.0.56 to 1.0.63 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4720
* build(deps): bump uuid from 1.3.2 to 1.3.4 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4706
* build(deps): bump openssl from 0.10.54 to 0.10.55 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4711
* build(deps): bump sha2 from 0.10.6 to 0.10.7 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4705
* build(deps): bump toml from 0.7.4 to 0.7.5 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4721
* build(deps): bump blake3 from 1.3.3 to 1.4.1 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4748
* build(deps): bump proc-macro2 from 1.0.63 to 1.0.64 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4746
* build(deps): bump pretty_assertions from 1.3.0 to 1.4.0 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4744
* build(deps): bump num_cpus from 1.15.0 to 1.16.0 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4738
* build(deps): bump tokio from 1.28.2 to 1.29.1 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4737
* build(deps): bump toml from 0.7.5 to 0.7.6 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4745
* build(deps): bump quote from 1.0.27 to 1.0.29 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4736
* build(deps): bump proc-macro2 from 1.0.64 to 1.0.66 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4766
* build(deps): bump anyhow from 1.0.71 to 1.0.72 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4765
* build(deps): bump semver from 1.0.16 to 1.0.18 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4764
* build(deps): bump uuid from 1.3.4 to 1.4.1 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4761
* build(deps): bump quote from 1.0.29 to 1.0.31 by @dependabot in https://github.com/graphprotocol/graph-node/pull/4776
 -->
